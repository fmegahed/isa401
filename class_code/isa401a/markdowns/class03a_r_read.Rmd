...
# overwritting my results (optional depending on your data analysis strategy)
...
# if you want to combine the different rows for that same job that got put in 4 rows, you can group by the job id (unique) and then summarise to combine the
...
Note that the choice of converting from list columns to seperate cols/rows will depend on your data analysis strategy
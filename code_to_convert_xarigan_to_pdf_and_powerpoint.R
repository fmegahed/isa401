...
renderthis::to_pdf(from = 'lectures/27_clustering_intro/27_clustering_intro.html',
                   to = 'pdfs/27_clustering_intro.pdf',
                   complex_slides = TRUE,
                   partial_slides = TRUE,
                   delay = 1)

# I am using my adobe to create the ppt since the text is editable (which is more preferable to students)
renderthis::to_pptx(from = 'lectures/27_clustering_intro/27_clustering_intro.html',
                    to = 'ppts/27_clustering_intro.pptx',
                    complex_slides = TRUE,
                    partial_slides = TRUE,
                    delay = 1)

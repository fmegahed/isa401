...
renderthis::to_pdf(from = 'lectures/18_ts_charts/18_ts_charts.html',
                   to = 'pdfs/18_ts_charts.pdf',
                   complex_slides = TRUE,
                   partial_slides = TRUE,
                   delay = 1)

# I am using my adobe to create the ppt since the text is editable (which is more preferable to students)
renderthis::to_pptx(from = 'lectures/18_ts_charts/18_ts_charts.html',
                    to = 'ppts/18_ts_charts.pptx',
                    complex_slides = TRUE,
                    partial_slides = TRUE,
                    delay = 1)

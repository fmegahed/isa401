...
renderthis::to_pdf(from = 'lectures/10_tidy_data/10_tidy_data.html',
                   to = 'pdfs/10_tidy_data.pdf',
                   complex_slides = TRUE,
                   partial_slides = TRUE,
                   delay = 1)

# I am using my adobe to create the ppt since the text is editable (which is more preferable to students)
renderthis::to_pptx(from = 'lectures/10_tidy_data/10_tidy_data.html',
                    to = 'ppts/10_tidy_data.pptx',
                    complex_slides = TRUE,
                    partial_slides = TRUE,
                    delay = 1)

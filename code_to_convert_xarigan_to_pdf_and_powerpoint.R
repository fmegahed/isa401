...
renderthis::to_pdf(from = 'lectures/25_clustering_intro/25_clustering_intro.html',
...
renderthis::to_pptx(from = 'lectures/25_clustering_intro/25_clustering_intro.html',

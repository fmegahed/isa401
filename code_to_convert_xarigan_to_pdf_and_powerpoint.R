...
renderthis::to_pdf(from = 'lectures/09_tidy_data/09_tidy_data.html',
                   to = 'pdfs/09_tidy_data.pdf',
                   complex_slides = TRUE,
                   partial_slides = TRUE,
                   delay = 1)

# I am using my adobe to create the ppt since the text is editable (which is more preferable to students)
renderthis::to_pptx(from = 'lectures/09_tidy_data/09_tidy_data.html',
                    to = 'ppts/09_tidy_data.pptx',
                    complex_slides = TRUE,
                    partial_slides = TRUE,
                    delay = 1)

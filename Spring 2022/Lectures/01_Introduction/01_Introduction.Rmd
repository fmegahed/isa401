...
mono <- style_mono_accent(base_color = "#84d6d3")
...
```{r viz2b, echo=FALSE, results=FALSE, cache=TRUE}
...
```{r research_megahed3, echo=FALSE, out.width='100%', fig.alt="My work can be grouped into four different clusters", fig.align='center', fig.cap='My work can be grouped into four different clusters.', dpi=600}
CS$graph_terms 
```

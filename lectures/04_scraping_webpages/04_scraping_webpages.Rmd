...
# Going Over Assignment 03 Solutions
...
.small[
When you read the `patterson_cafe_yelp_reviews.rds` in R/RStudio, the column titled `review_date` is being recognized by `r fa('r-project')` as] 
...
> _Over the next 4 minutes, use an `r fa('r-project')` script file to perform the tasks outline in the activity panel._
...
- Go over your notes, read through the supplementary material (below) and complete [Assignment 04](https://miamioh.instructure.com/courses/179812/assignments/2214280) on Canvas. 

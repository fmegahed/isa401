...
Use the $k$-means algorithm to cluster the following observations. Use $k=2$ and Euclidean distance. **Use [this handout](https://miamioh.instructure.com/courses/213901/files/31736802?module_item_id=5141293) to go through the $k$-means algorithm implementation (by hand).**
...
**Solution:** Once you complete the handout, you can check your solution by downloading [this file](https://miamioh.instructure.com/courses/213901/files/31736803/download?download_frd=1). 
]

...
Let us use `r fontawesome::fa('r-project')` inside Power BI to create this based on [cincy_daily_crashes.csv](https://raw.githubusercontent.com/fmegahed/isa401/main/data/cincy_daily_crashes_2023.csv).

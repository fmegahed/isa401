...
knitr::include_graphics('../../figures/extrapolating.png')
```
]
...
.pull-left[
.center[
```{r ethical, echo=FALSE, out.width='100%'}
knitr::include_graphics('../../figures/51eUw-v0X+L._SX329_BO1,204,203,200_.jpg')
```
]
]
...
```{r ethical2, echo=FALSE, out.width='100%'}
knitr::include_graphics('../../figures/51obBtKNC5L._SX331_BO1,204,203,200_.jpg')
```
...
.center[
```{r datasciencepm, echo=FALSE, out.width='100%'}
knitr::include_graphics('../../figures/process-google-search-volume-2019-2020.png')
```
]

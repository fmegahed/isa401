...
- We will build on the previous example and we will scrape all the plane crashes that were recorded in the [plane crash database](http://www.planecrashinfo.com/) between 2020-2025. 
...
**Winning the competition involves having as many correct answers as possible AND taking the shortest duration to answer these questions.** The winner `r fontawesome::fa(name = 'trophy', fill = 'gold')` of the competition will receive a 0.15 bonus on the next assignment. Good luck!!!
...
- Go over your notes, read through the supplementary material (below), and complete [Assignment 05](https://miamioh.instructure.com/courses/240893/assignments/3251703) on Canvas. 

...
subtitle: "26: A Short Introduction to Clustering"
...
Use the $k$-means algorithm to cluster the following observations. Use $k=2$ and Euclidean distance. **Use [this handout](https://miamioh.instructure.com/courses/240893/files/37533887?module_item_id=6279582) to go through the $k$-means algorithm implementation (by hand).**
...
**Solution:** Once you complete the handout, you can check your solution (starting from Saturday) by downloading [this file](https://miamioh.instructure.com/courses/240893/modules/items/6279583). 
]

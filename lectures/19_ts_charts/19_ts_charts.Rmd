...
nbaPerGame = 
  read_html("https://www.basketball-reference.com/leagues/NBA_2025_per_game.html") |> 
...
write_csv(x = nbaPerGame, file = '../../data/nba_per_game25.csv')
...
```{r nba2, echo = FALSE}
nbaPerGame = read_csv('../../data/nba_per_game25.csv')
...
**Source:** Data scraped from [Basketball-Reference ](https://www.basketball-reference.com/leagues/NBA_2025_per_game.html)on `r Sys.Date() |>  format('%B %d, %Y')` using the [rvest](https://cran.r-project.org/web/packages/rvest/rvest.pdf) `r fontawesome::fa('box', 'gold')`. The printing was limited to the selected variables.
]

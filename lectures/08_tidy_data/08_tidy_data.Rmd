...
# Open Jobs for your Existent Skillset

```{r boozallen, echo=FALSE, fig.alt= 'An Ad for a Junior Data Engineer at Booz Allen (Last Accessed Sept 16, 2022)', out.width="575px"}
knitr::include_graphics('../../figures/booz_allen_2022.png')
```
...
**Source:** [Data Engineer, Junior, Booz Allen](https://careers.boozallen.com/jobs/JobDetail/McLean-Data-Engineer-Junior-R0152735/67124?source=JB-14400)
]
...
```{r p&g, echo=FALSE, fig.alt= 'An Ad for Corporate Function (CF) Human Safety Data/Software Engineer at P&G (Last Accessed Sept 16, 2022)', out.width="475px"}
knitr::include_graphics('../../figures/p&g_2022.png')
```
...
**Source:** [Corporate Function (CF) Human Safety Data/Software Engineer, P&G](https://pg.wd5.myworkdayjobs.com/1000/job/Mason/Corporate-Function--CF--Human-Safety-Data-Software-Engineer_R000002853-1?source=Indeed&source=RS_INDEEDSPONSORED)
]
...
```{r lp, echo=FALSE, fig.alt= 'An Ad for Business Intelligence and Data Visualization Analyst at LP Analyst (Last Accessed Sept 16, 2022)', out.width="425px"}
knitr::include_graphics('../../figures/lp_2022.png')
```
...
**Source:** [Business Intelligence / Data Visualization Analyst, LP Analyst](https://www.indeed.com/viewjob?jk=82284b002f5aa4d1&tk=1gd4ine0lkbne800&from=serp&vjs=3)
]
...
Please go through the following two supplementary readings and complete [assignment 08: tidy data](https://miamioh.instructure.com/courses/179812/quizzes/489446?module_item_id=4026910).

...
subtitle: "27: A Short Introduction to Clustering"
...
Use the $k$-means algorithm to cluster the following observations. Use $k=2$ and Euclidean distance. **Use [this handout](https://miamioh.instructure.com/courses/202961/files/29954326?module_item_id=4797354) to go through the $k$-means algorithm implementation (by hand).**
...
**Solution:** Once you complete the handout, you can check your solution by downloading [this file](https://miamioh.instructure.com/files/29954351/download?download_frd=1). 
]

...
subtitle: '09: Connecting to APIs in `r icons::icon_style(icons::fontawesome("r-project"), fill = "white")`'
...
```{r crypto, echo = FALSE}
crypto = jsonlite::fromJSON("https://min-api.cryptocompare.com/data/histoday?fsym=BTC&tsym=USD&limit=100") |> magrittr::extract2('Data')
...
- Go over your notes, read through the supplementary material (below), and complete [assignment 07](https://miamioh.instructure.com/courses/202961/assignments/2564834) on Canvas. 

...
**Source:** Data scraped from  <https://www.basketball-reference.com/leagues/NBA_2024_per_game.html}{Basketball-Reference> on `r Sys.Date() |>  format('%B %d, %Y')` using the [rvest](https://cran.r-project.org/web/packages/rvest/rvest.pdf) `r fontawesome::fa('box', 'gold')`. The printing was limited to the selected variables.
]

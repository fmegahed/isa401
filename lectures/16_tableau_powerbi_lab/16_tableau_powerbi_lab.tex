...
\begin{enumerate}[label=(\Alph*)]
	...
	\begin{itemize}[nosep]
		\item MONTH
		\item FL\_DATE
		\item Airline % Marketing_Airline_Network
		\item FL\_NUM % Flight_Number_Marketing_Airline
		\item ORIGIN\_CITY\_NAME % OriginCityName
		\item DEST\_CITY\_NAME % DestCityName
		\item DEP\_DELAY 
		\item ARR\_DELAY
	\end{itemize}

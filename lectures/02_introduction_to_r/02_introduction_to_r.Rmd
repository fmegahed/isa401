...
`r emo::ji("check")` Describe the **analytics journey** (pre-analytics, descriptive, predictive, prescriptive) and where **BI** fits within it.

`r emo::ji("check")` Explore a **BI dashboard** and identify the questions it can (and cannot) answer. 

`r emo::ji("check")` Define **data visualization** and describe its main goals (record, analyze, communicate, interact).

`r emo::ji("check")` Identify the **unit of analysis** in a dataset (rows vs. observations).

`r emo::ji("check")` Recognize how data is **visually encoded** (position, size, color, shape).
...
```{r taylor_swift, echo=FALSE, out.width='70%'}
knitr::include_graphics('../../figures/the_weeknd.png')
```
...
**Note:** Image generated using [ChatGPT's Image Generation Tool](https://chatgpt.com/share/697fee6d-5ee4-8005-8e82-d9794f85dbd0) on Feb 01, 2026. 
]
...
- As of `r Sys.Date() |> format(format = '%b %d, %Y')`, there are 22,578 packages on [CRAN](https://cran.r-project.org/) (not including those on `r fontawesome::fa("github")`).   
...
## Your Knowledge of `r fontawesome::fa("r-project")`

<div style="height:490px; margin:0; padding:0; overflow:hidden;">
  <iframe
    src="https://www.mentimeter.com/app/presentation/alsb3k467qeyyndogrc34rqqc3194c8c/embed"
    frameborder="0"
    allowfullscreen
...
## Class Activity: Setting Up Your RStudio Project

`r countdown::countdown(minutes = 2, font_size = "48px", top = 0)`

1. In RStudio: **File > New Project > Version Control > Git**
2. In **Repository URL**, paste your GitHub repo URL (example: `https://github.com/fmegahed/data_viz.git`)
3. Accept the default **Project directory name** (matches the repo name)
4. Choose a location you will remember (be intentional)
5. Check **Open in new session**
6. Click **Create Project**
7. In the Files pane, confirm you see `README.md`

If you do **not** see **Version Control**, see the second link below for details.

.footnote[
<html>
<hr>
</html>
**Source:** [Happy Git with R, Chapter 12](https://happygitwithr.com/rstudio-git-github#clone-the-test-github-repository-to-your-computer-via-rstudio). In all likelihood, we will probably need to install [Git](https://happygitwithr.com/install-git.html) first. See the previous link for information about Git in both Windows and Macs.
]
...
.pull-right[
.center[
<img src="../../figures/install_use.png" height="500px">
]
]
...
To assess your understanding and retention of the topics covered so far, you will **compete in a Kahoot competition (consisting of 8 questions)**:  
...
- Go over this slide deck, your notes, the zoom recording (if necessary), and watch this 6 minute notebookLM generated video of our slide deck. 

<iframe width="100%" height="380"
src="https://www.youtube.com/embed/blpwohIHmDU?autoplay=0"
...
.pull-right[
.center[[<img src="https://d33wubrfki0l68.cloudfront.net/565916198b0be51bf88b36f94b80c7ea67cafe7c/7f70b/cover.png" height="300px">](https://adv-r.hadley.nz)]
.small[
...
- Complete [Assignment 02](https://miamioh.instructure.com/courses/250351/quizzes/785474) on Canvas to reinforce your understanding and application of the topics covered today as well as the assigned readings. 

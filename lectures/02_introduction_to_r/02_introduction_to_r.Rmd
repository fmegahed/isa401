...
- Utilize the project workflow in `r fa(name = "r-project")` and create your first `r fa(name = "r-project")` script. 
...
# Your First `r fa(name = "r-project")` Script File
...
- Complete [Assignment 02](https://miamioh.instructure.com/courses/213901/quizzes/619334) on Canvas.  

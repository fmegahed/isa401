...
\begin{document}
	...
	\centering
		\begin{tikzpicture}[node distance=2cm, font=\small]
			...
			% Level 1 nodes
			\node (etl) [categories, below of = start, xshift=-0.35\textwidth] {\textbf{\underline{Phase I:} ETL} \\ (Weeks 1-5)};
			\node (viz) [categories, below of = start, xshift = 0in] {\textbf{\underline{Phase II:} Data viz} \\ (Weeks 6-11)};	

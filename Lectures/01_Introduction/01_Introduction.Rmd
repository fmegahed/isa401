...
**Predictive Analytics:** where **statistical** and **machine learning** models are used to help us utilize indepedent variable[s] to predict an outcome variable.

```{r two_papers, echo=FALSE, out.width='50%', fig.show="hold", fig.align='default', out.height='50%'}
...
```{r qiong_ksp, echo=FALSE, out.width='400px', fig.alt="k-SP solution to feasible routes between Gary, IN and Nashville, TN", fig.align='center'}
...
- Rread through the following references in preparation of our next class. 

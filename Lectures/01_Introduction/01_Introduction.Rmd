...
- Write basic `r icons::icon_style(icons::fontawesome('r-project'), fill = miamired)` scripts to preprocess and clean the data.  
...
residence = tribble(
  ...
  "Oxford",      "Ohio", 39.5070,  -84.7452,   6,    "Assistant-Associate Professor of <br> Business Analytics <br> Farmer School of Business <br> Miami University"
) 
...
- Go over your notes and complete [Assignment 01](https://miamioh.instructure.com/courses/179812/quizzes/489447) on Canvas.  

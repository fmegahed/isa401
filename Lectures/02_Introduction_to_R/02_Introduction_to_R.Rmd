...
.center[
```{r flexdashboard, echo=FALSE, out.width=800, out.height=350}
knitr::include_url("https://beta.rstudioconnect.com/jjallaire/htmlwidgets-showcase-storyboard/htmlwidgets-showcase-storyboard.html")
```
]
]

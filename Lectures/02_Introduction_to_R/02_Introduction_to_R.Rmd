...
output:
  xaringan::moon_reader:  
    self_contained: true
    css: [default, "css/fonts.css", "css/my-theme.css", "css/my-theme.css","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"]
    lib_dir: libs
    nature:
...
.center[
```{r flexdashboard, echo=FALSE}
knitr::include_url("http://rstudio.fsb.miamioh.edu:3838/megahefm/isa444/class28/")
```
]
]
...
<br>
.center[
<img src="figures/install-library.JPG" height="250px">
]
]

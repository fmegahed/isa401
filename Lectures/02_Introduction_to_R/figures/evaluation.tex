...
\begin{tikzpicture}[node distance=2cm, font=\small]
	...
	\node (e4) [categories, right of = e3, xshift=0.125\textwidth] {Project \\ (10\%)};
	
	\node (e5) [categories, below of = e3, xshift=-0.25\textwidth] {Exam I \\ (30\%)};
	\node (e6) [categories, below of = e3, xshift=0in] {Exam II \\ (30\%)};
	\node (e7) [categories, below of = e3, xshift=0.25\textwidth] {Exam III \\ (10\%)};

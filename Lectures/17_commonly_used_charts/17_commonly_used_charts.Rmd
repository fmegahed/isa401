...
# Refresher: Important Data Viz Concepts 

.panelset[

.panel[.panel-name[Activity]

> _Over the next several minutes, you will assess/demonstrate your knowledge of the covered material pertaining to the fundamentals of data visualization through 7-questions on Kahoot. To answer the questions, please do the following:_


  - Go to [www.kahoot.it](www.kahoot.it)  
  
  - Insert the game pin shared on the screen
  
  - Add your first and last name when asked for a name
  
  - To get the most points per question, answer each question **correctly** and **quickly**
  
  - Winner is the person with the most points after seven questions

]

.panel[.panel-name[Solution Notes]

As we go over each question, I will highlight the correct answer and the logic associated with why such an answer was chosen. Please feel free to use the area below to take notes. 
...
knitr::include_graphics('https://arvo.silverchair-cdn.com/arvo/content_public/journal/jov/938565/i1534-7362-21-12-17-f4_1638249510.72654.png?Expires=1651128420&Signature=K35TFovaWqv1knBLhQeSUZTovv~Mv3fWnZ3Cwz8ySbBk-RQJ5IZ5M~-3~A21cgOnXljJuRZe7Z0Mn9g52nDeUjfw0L3wEFufDI4o90Vo2md7jjzaFnbUE5mJ2wEjKEoWwIf4SAzxP2fK~6Be0ur~SmjJzFnRZSI0DsSiPSsJHmtwQ9em-q6NXrr0aK6-h7hkWLiSKTWrOjxRH8b-1hbJv16NV8EVQk2rS6IhRpCZO0Zj1bmXQnadxsGacSiCobEPBlk5XyUlKr-S2V5-uNCU9gdpIVGcCmRActBABT9EiFpRmcK1FcJdmWEkpHiHcbJ-QSwl~CPfqaRNRfhx8Qk2yw__&Key-Pair-Id=APKAIE5G5CRDK6RD3PGA')
```
...
knitr::include_graphics('https://arvo.silverchair-cdn.com/arvo/content_public/journal/jov/938565/i1534-7362-21-12-17-f2_1638249510.66151.png?Expires=1651128420&Signature=HtX37FipYS55HNb7YxtyPG6lbbBwzr8GIPouGJdUFO6fcET6U8Ac2mELPH7nhaKOpPCFkmHlEij1bpJVHz~3ReLtsjSXlxX1E5fdpeRsqHGki4qc-zjj8pgzHqM1ViJMGI-vYFSU4JkgQb0JQsW4O7q726Ob1BXPs2OatsvRH6UEfSPhm23B0hEQKyRbx~oSH9ebk0EcnJZi3Ly8dP~hOKXVH9mmXINMG5QPyGAlcjyYhjPk0yEVaXXAAMtIEKU8ZJ~8c~K7I959N7nIBS0QLubH~2zOPnglMGEa44~YyciQ~R-3XaaDIb-hLyM8T9mEzMHKo~OBBc3zZ4gCAgUyPA__&Key-Pair-Id=APKAIE5G5CRDK6RD3PGA')
```
...
<center>
<div class='visually_embed'><img class='visually_embed_infographic' src='https://visual.ly/node/image/51878?_w=500' alt='Did you know some countries require you to take a vacation?' /><div class='visually_embed_cycle'></div><script type='text/javascript' src='https://a.visual.ly/api/embed/51878?width=500' class='visually_embed_script' id='visually_embed_script_51878'></script><p> From <a href='https://visual.ly?utm_source=content-embed&utm_medium=embed'>Visually</a>.</p></div>
</center>
...
# 3D Charts are Awful: Possible Exception

```{r chart_exception_1, echo = FALSE, out.width='125%'}
